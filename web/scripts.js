...
function sendCommand(direction) {
	const xhr = new XMLHttpRequest();
	xhr.open("POST", `http://137.194.173.32:8080/api/move?direction=${direction}`, true);
	xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
...
function sendNavigateRequest() {
	...
	const xhr = new XMLHttpRequest();
	xhr.open("POST", `http://137.194.173.32:8080/api/launch?navigate&start=${startCell}&target=${targetCell}`, true);
	xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
